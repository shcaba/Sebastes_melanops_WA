...
caption = "Log relative change $(log((Model_sensi-Model_ref)/Model_ref))$ in data treatment for 5 derived quantities. Colored boxes indicate 95 percent confidence interval of the reference model. See Sensitivity Analysis section for more details on each scenario",label = 'sensi-data-RE')
```
