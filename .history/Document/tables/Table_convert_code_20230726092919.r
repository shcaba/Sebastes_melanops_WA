...
out<-read.csv("C:/Users/Jason.Cope/Documents/Github/Sebastes_melanops_WA/Document/tables/Likes_parms_devquants_table_data_scenarios_SHORT.csv")
t = table_format(x = out,
      caption = 'Likelihood, parameter and derivied quantities from data treatment sensitivities.',
...
kableExtra::save_kable(t,file = file.path("C:/Users/Jason.Cope/Documents/Github/Sebastes_melanops_WA/Document/tex_tables/data_sensis_SHORT.tex"))
kableExtra::save_kable(t,file = file.path("C:/Users/Jason.Cope/Documents/Github/Sebastes_melanops_WA/Document/tex_tables/data_sensis_SHORT_postSTAR.tex"))
