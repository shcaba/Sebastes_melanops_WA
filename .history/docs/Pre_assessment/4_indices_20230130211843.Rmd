...
* Nearshore Coastal Rod-and-Reel Survey (2019-2022): In 2019 WDFW implemented an annual standardized nearshore rod-and-reel survey at 125 index stations off the Washington coast.  Survey results provide an adult relative abundance measure, however survey data from 2020 is truncated due to Covid-19.
...
* Fishery-Independent Indices Items: The historical tag-release data series is long, however there is a large gap in the data from 1990 through 1997. Additionally, data prior to 1990 may not be as reliable as data in the later part of the data series. Assessment authors are considering truncating the data to begin the indices in 1998.
* Assessment authors have discussed combining data from the historical tag-release data series and the nearshore coast rod-and-reel survey to extend the historical time series through 2022.  If this were done the coastwide nearshore rod-and-reel indices would not be used for this assessment. Nearshore survey data would be limited to spring surveys in MA2 to standardize the data, but concerns have been raised about the prescriptive nature of the survey vs. the inconsistent fishing methods during historic surveys. 
* Fishery-Dependent Indices Items: Bag limits have changed for Black Rockfish over time. These changes may impact the indices and recreational selectivity information.
