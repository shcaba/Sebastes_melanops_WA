...
```{r, results = 'asis'}
add_figure(
filein = file.path(likeprof_fig_loc,"like_component_profile.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(likeprof_fig_loc,"length_component_profile.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(likeprof_fig_loc,"age_component_profile.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(likeprof_fig_loc,"survey_component_profile.png"), 
