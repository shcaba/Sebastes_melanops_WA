...
plot.vec = c(grep("comp_condAALfit_residsflt1mkt0", len_fit$label),
			 ...
			 grep("comp_condAALfit_residsflt3mkt0", len_fit$label))
...
plot.vec = plot.vec[find[1:length(find)]]
filein = file.path(mod_loc, "plots")
cap.in=c("Trawl conditional AAL plot (plot 1 of 5) showing mean age (left panel) and standard deviation (right panel. Shaded areas are 90 percent CIs)",
...
"Non-trawl conditional AAL plot (plot 1 of 7) showing mean age (left panel) and standard deviation (right panel. Shaded areas are 90 percent CIs)",
"Non-trawl conditional AAL plot (plot 2 of 7)",
"Non-trawl conditional AAL plot (plot 3 of 7)",
"Non-trawl conditional AAL plot (plot 3 of 7)",
"Non-trawl conditional AAL plot (plot 4 of 7)",
"Non-trawl conditional AAL plot (plot 5 of 7)",
"Non-trawl conditional AAL plot (plot 6 of 7)",
"Non-trawl conditional AAL plot (plot 7 of 7)",
"Ocean boat conditional AAL plot (plot 1 of 6) showing mean age (left panel) and standard deviation (right panel. Shaded areas are 90 percent CIs)",
"Ocean boat conditional AAL plot (plot 2 of 6)",
"Ocean boat conditional AAL plot (plot 3 of 6)",
"Ocean boat conditional AAL plot (plot 3 of 6)",
"Ocean boat conditional AAL plot (plot 4 of 6)",
"Ocean boat conditional AAL plot (plot 5 of 6)",
"Ocean boat conditional AAL plot (plot 6 of 6)"
	)
