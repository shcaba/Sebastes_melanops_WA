...
alt_caption = "Number at age are found in the model output Report file")
```
...
alt_caption = "Mean lengths are found in the model output Report file")
```
