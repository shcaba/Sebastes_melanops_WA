...
Alaska has initiated stock assessments for `r spp` throughout the state. These efforts are ongoing.
...
```{r, results = 'asis'}
add_figure(
filein = file.path(mod_loc, "plots", "catch-ts-comparison.png"), 
