...
\textbf{NEED TO UPDATE THE TABLE BELOW} \input{tex_tables/project_ES.tex}
...
\paragraph{Tagging data}\label{tagging-data}}
...
Cleaver, F.C. 1965. Fisheries statistics of oregon. Oregon Fish Comm. Contr.
...
Council, P.F.M. 2004. Acceptable biological catch and optimum yield specification and management measures for the 2005-2006 pacific coast groundfish fishery. Pacific Fishery Management Council, 7700 Ambassador Place NE, Suite 200, Portland, OR.
...
Parker, S.J., McElderry, H.I., Rankin, P.S., and Hannah, R.W. 2006. Buoyancy regulation and barotrauma in two species of nearshore rockfish. Transactions of the Amer. Fish. Society \textbf{135}(5): 1213--1223. doi:\href{https://doi.org/10.1577/T06-014.1}{10.1577/T06-014.1}.
...
\leavevmode\vadjust pre{\hypertarget{ref-sampson_commercial_1997}{}}%
Sampson, D.B., and Crone, P.R. 1997. Commercial fisheries data collection procedures for {U}.{S}. {Pacific} {Coast} groundfish. NOAA Tech. Memo.
...
Tsou, T.S., Wargo, L.L., Langness, M., Colin, J., LeGoff, R.S., Downs, D.E., Okimura, V.S., Walker, B., and Bacon, D.D. 2015. Washington coastal commercial groundfish port sampling program: 2015 report. FPA, Washington Department of Fish; Wildlife.

\leavevmode\vadjust pre{\hypertarget{ref-tsou_weyland_2015}{}}%
Tsou, T.S., and Weyland, P.M. 2015. Washington commercial groundfish fisheries data collection and processing. FPA, Washington Department of Fish; Wildlife.
...
\caption{Length compositions by year from the commercial trawl fleet.\label{fig:trawl-length-data}}
\end{figure}
...
\caption{Length compositions by year from the commercial nontrawl fleet.\label{fig:nontrawl-length-data}}
\end{figure}
...
\caption{Length compositions by year from the recreational fleet.\label{fig:rec-length-data}}
\end{figure}
...
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{C:/Users/Jason.Cope/Documents/Github/Sebastes_melanops_WA/Document/models/Reference model/plots/SPR4_phase.png}
\caption{Phase plot of biomass ratio vs.~SPR ratio. Each point represents the biomass ratio at the start of the year and the relative fishing intensity in that same year. Warmer colors (red) represent early years and colder colors (blue) represent recent years.\label{fig:phase-plot}}
\end{figure}
...
\centering
\includegraphics[width=1\textwidth,height=1\textheight]{C:/Users/Jason.Cope/Documents/Github/Sebastes_melanops_WA/Document/models/Reference model/plots/yield2_yield_curve_with_refpoints.png}
\caption{Yield curve with reference points.\label{fig:yield-curve}}
\end{figure}
...
\caption{Pearson residuals, whole catch, Trawl (max=8.73) (plot 1 of 3).\label{fig:comp_condAALfit_residsflt1mkt0_page1}}
\end{figure}
...
\caption{Pearson residuals, whole catch, Trawl (max=8.73) (plot 2 of 3).\label{fig:comp_condAALfit_residsflt1mkt0_page2}}
\end{figure}
...
\caption{Pearson residuals, whole catch, Trawl (max=8.73) (plot 3 of 3).\label{fig:comp_condAALfit_residsflt1mkt0_page3}}
\end{figure}
