...
# Final Year SSB
ssb_2021 = format(model$derived_quants[model$derived_quants$Label == paste0("SSB_",endyr), 2], digits = 2, scientific = FALSE, big.mark = ",") 
...
ssb_2021_low = format(low, digits = 2, scientific = FALSE, big.mark = ",") 
ssb_2021_hi = format(hi, digits = 2, scientific = FALSE, big.mark = ",") 

# Final Year Depletion
depl_2021 = round(model$derived_quants[model$derived_quants$Label == paste0("Bratio_",endyr), 2], digits = 2) 
