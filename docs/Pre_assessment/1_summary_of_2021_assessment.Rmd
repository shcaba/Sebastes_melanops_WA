...
add_figure(
  ...
  caption = "Estimates of spawning output (millions of eggs) for black rockfish in waters off Washington from the 2015 assessment. Broken lines are 95% confidence intervals",
  label = 'ssb2015')
